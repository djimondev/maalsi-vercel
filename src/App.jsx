...
import "./index.css";
import { createVideo, getVideos, reportVideo, updateVideoReaction } from "./services/video-service";
...
function App() {
    ...
    useEffect(() => {
        ...
        getVideos()
            .then(initialData => {
                const data = initialData.filter(video => !video.reported_by?.includes(user?.id));
    ...
    const handleLikeVideo = async videoId => {
        ...
        setFilteredResults(prev => prev.map(video => (video.id === updatedVideo.id ? updatedVideo : video)));
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 pt-20 pb-8">
                ...
                <VideoList loading={loading} videos={filteredResults} setSelectedVideo={setSelectedVideo} />
            </main>
            {selectedVideo && (
                <VideoPlayer
